...
- ONTOLOGICAL FILTER RULES:
  ...
  3. CONTEXT — Macro-Historical Rupture on the Core Subject: Synthesize the DIRECT CAUSAL AND STRUCTURAL PRESSURE of the input's macro historical/geopolitical ruptures and structural factors ON the auto-detected Core Empirical Subject. The query must remain locked onto the Core Subject at all times. Generic encyclopedia-style world history without a direct line to the Core Subject is STRICTLY FORBIDDEN.
