...
- ÇIKTI FORMATI: Yanıtın, yukarıda sağlanan enhancedThesisSchema ile %100 uyumlu, doğrulanmış ve parse edilebilir bir ham JSON objesi olmalıdır. Follow the provided JSON schema exactly. Do not add extra fields.
