...
2. **Sorgu Uyumı:** Sorgular Meilisearch uyumlu, yalnızca boşlukla ayrılmış düz akademik Türkçe ve İngilizce kelimelerden oluşmalı; özel karakter veya operatör içermemelidir.
...
\`\`\``,
    ...
    inputContext: `Aşağıdaki matris alanı için kademeli (spesifikten geniş tematik kapsama) Türkçe ve İngilizce Meilisearch sorguları üret (her dil için 4 alternatif, toplam 8 sorgu):
