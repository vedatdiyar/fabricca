...
export async function sendMessageAction(
  ...
  try {
    ...
    const systemInstruction =
      ...
      "Yanıtlarını her zaman son derece saygın, teşvik edici, yapıcı bir akademik üslupla (örneğin 'Vedat, tez çalışmanda bu nokta önemli' gibi samimi bir üslupla) ve temiz Markdown formatında sun. Başlıklar, listeler ve vurgulamalar kullanarak okunabilirliği maksimize et.";
