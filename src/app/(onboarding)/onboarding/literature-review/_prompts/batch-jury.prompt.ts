...
3. **Akademik Kademe ve Hakemlik Süzgeci:** Yayımlanmış hakemli kitapları, monografileri ve uluslararası makaleleri öncelikli (TIER_1) tut. Ulusal tez arşivinden (YÖK) gelen çalışmalarda: Doktora tezlerini tezin konusuna doğrudan ve özgün ampirik katkı sunuyorsa kabul et (TIER_1 veya TIER_2); ancak Yüksek Lisans (YL / Master) tezlerini, hakem denetimi ve kuramsal derinlik kısıtı nedeniyle TIER_1 kabul etme, en fazla TIER_2 (destekleyici) olarak değerlendir veya alanda güçlü hakemli alternatifler varsa ele (REJECT).
...
8. **Kanonik Başyapıt ve Kurucu Ekol Önceliği (Canonical Priority):** Alt kutu açıklamasında tezin benimsediği belirli bir çağdaş analitik yazar zikredilmiş olsa dahi; değerlendirilen aday eser, o yöntemin veya kuramın uluslararası literatürde standardını kuran yüksek atıflı kanonik bir kurucu başyapıtı (yöntemin kurucu el kitabı, paradigmaya adını veren ana monografi) ise, bu eser yalnızca kutu açıklamasında adı geçen spesifik yazarla harfiyen eşleşmediği gerekçesiyle ASLA elenemez (REJECT edilemez) veya puanı kırılamaz. Kurucu başyapıtlar doğrudan TIER_1 kabul edilmelidir.
9. **3 Kademeli Jüri Sınıflandırması (Kategorik Standartlar):**
