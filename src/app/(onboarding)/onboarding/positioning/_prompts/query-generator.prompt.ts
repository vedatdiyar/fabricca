...
<instructions>
# Görev ve Amaç
Kullanıcının araştırma konusunu, kuramsal çerçevesini ve yöntemini analiz ederek, 4 farklı akademik kanalda eşzamanlı taranacak toplam 6 odaklanmış sorgu ve anahtar kavramları üret.

# 6 Odaklı Sorgu Mimarisi
...
3. **globalTheoreticalQuery (OpenAlex & Semantic Scholar / İngilizce):**
...
4. **globalEmpiricalQuery (OpenAlex & Semantic Scholar / İngilizce):**
...
6. **fieldWebQuery (Exa.ai - Canlı Saha & Raporlar / Türkçe):**
...
<task>
Yukarıdaki <context> içeriğini inceleyerek, 4 kanallı literatür taraması için 6 odaklı arama sorgusunu ve anahtar kavramları JSON formatında üret.
</task>`;
