        ...
        <CardContent className="p-4 sm:p-6 flex items-start gap-4">
          <div
            className={cn(
              ...
              isNovelGap
                ? "bg-background text-success border-success/20"
                : isDirectOverlap
                  ? "bg-background text-destructive border-destructive/20"
                  : "bg-background text-info border-info/20",
            )}
          >
            ...
            {sortedTheses.map((thesis, idx) => {
              ...
              return (
                <Card
                  ...
                  className="flex flex-col justify-between border border-border rounded-md bg-card transition-colors hover:border-border/80"
                >
                  <CardHeader className="p-4 sm:p-5 pb-3 sm:pb-3 space-y-2.5">
                    ...
                    <div className="space-y-1">
                      <CardTitle className="font-serif text-base font-semibold leading-snug tracking-tight text-foreground line-clamp-2">
                        {mainTitle}
                      </CardTitle>
                      {secondaryTitle && (
                        <p className="font-sans text-xs text-muted-foreground leading-normal line-clamp-2 italic">
                          {secondaryTitle}
                        </p>
                      )}
                    </div>
                  ...
                  <CardContent className="p-4 sm:p-5 pt-0 space-y-2.5 text-xs leading-relaxed text-muted-foreground font-sans flex-1">
                    ...
                    {thesis.relevanceReason && (
                      <div className="rounded-md bg-primary/5 p-3 border border-primary/20 space-y-1">
