...
export function BoxesContainer() {
  ...
  // Auto-generate when hydrated + loading done + no boxes + not generating
  useEffect(() => {
    if (
      hydrated &&
      !loading &&
  ...
  }, [hydrated, loading, boxes, generating, handleGenerate]);
      ...
      <div className="flex flex-col items-center text-center space-y-4 max-w-2xl mx-auto">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm">
            Tez matrisinizin çözümlenmesi tamamlandı ve yapay zeka tarafından 5
            ana kategori altında hazırlandı.
          </p>
        </div>
      </div>
