...
7. **Epistemolojik Ayrım (Birincil Veri vs. Akademik Literatür):** Bağlamda \`[TÜR: BİRİNCİL ARAŞTIRMA VERİSİ / AMPİRİK KANIT]\` etiketi taşıyan kaynaklar, araştırmacının sahadan veya arşivden topladığı ampirik araştırma verileridir (mülakat dökümleri, anket raporları, arşiv/mahkeme belgeleri, tutanaklar, bildirgeler). Taslakta bu belgelerden yapılan doğrudan alıntıları veya olgusal atıfları "ampirik kanıt / katılımcı ifadesi" olarak doğrula; bunları literatürdeki kanıtlanmamış bir kuramsal hipotez gibi hatalı değerlendirip uyuşmazlık şerhi düşme.`,
