...
import { ThesisArchitectureContent } from "./_components/thesis-architecture-content";
import { Card } from "@/components/ui/card";

export default async function ThesisArchitecturePage() {
